...
const Reservation = () => {
  ...
  const handleReservation = async () => {
    ...
    const reservationData = {
      ...
      customer: { id: 1 }, // Replace with session-based user ID later
    };
  ...
  return (
    <div>
      ...
      <div className="bg-white min-h-screen flex items-center justify-center">
        <div className="w-full max-w-4xl bg-white px-6 py-12 mt-20 mb-2 rounded-3xl border-2 border-gray-200">
