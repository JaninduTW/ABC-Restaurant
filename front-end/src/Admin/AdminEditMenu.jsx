  ...
  <div className="container">
    <div className="flex justify-center">
      <div className="w-full md:w-1/2 lg:w-1/3 bg-white p-8 rounded-lg shadow-lg my-6 ">
        <h2 className="text-center text-2xl font-bold mb-6">Edit Food Item</h2>
        ...
        <form onSubmit={(e) => onSubmit(e)} >
          ...
          <div className="flex justify-between">
            ...
            <Link type="button" className="outline outline-red-600 text-red-700 hover:bg-red-700 hover:text-white hover:outline-none font-bold py-2 px-4 rounded-lg" to='/adminmanageusers' >
              Cancel
            </Link>
          </div>
        </form>
