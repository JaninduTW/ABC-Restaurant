      ...
      <main className='flex-grow'>
        <div className='max-w-[1240px] mx-auto py-12 px-4  '>
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8 '>
            <Link to='/admin/reservations' className='bg-white rounded-lg p-6 shadow-2xl hover:shadow-lg transform hover:scale-105 transition-transform duration-300 border '>
            ...
            <Link to='/admin/queries' className='bg-[#f09c20] rounded-lg p-6  shadow-2xl hover:shadow-lg transform hover:scale-105 transition-transform duration-300 border '>
            ...
            <Link to='/admin/orders' className='bg-white rounded-lg p-6 shadow-2xl hover:shadow-lg transform hover:scale-105 transition-transform duration-300 border '>
            ...
            <Link to='/admin/content' className='bg-white rounded-lg p-6 shadow-2xl hover:shadow-lg transform hover:scale-105 transition-transform duration-300 border '>
            ...
            <Link to='/admin/reports' className='bg-[#f09c20] rounded-lg p-6 shadow-2xl hover:shadow-lg transform hover:scale-105 transition-transform duration-300  border '>
            ...
            <Link to='/admin/settings' className='bg-white rounded-lg p-6 shadow-2xl hover:shadow-lg transform hover:scale-105 transition-transform duration-300 border '>
